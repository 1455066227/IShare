 ...
 * Color shades will provide all the intermediate colors between two colors. It
 * just requires a decimal value between 0.0 to 1.0 and it provides the exact
 * shade combination of the two color with this shade value. Textual explanation
 * :
 * 
 * White LtGray Gray DkGray Black 0 0.25 0.5 0.75 1 Given two colors as White
 * and Black,and shade as 0 gives White as 0.25 gives Light gray as 0.5 gives
 * Gray as 0.75 gives Dark gray as 1 gives Black.
 *
 * @author https://gist.github.com/cooltechworks/4f37021b1216f773daf8
 */
public final class ColorShades
{
